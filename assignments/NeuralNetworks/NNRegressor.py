...
class NNRegressor(SingleLayerNetwork):
    """
        A Neural Network class for Regression.
    """
    ...
    def train(self, X_tr, Y_tr, 
        ...
        # This starts training our SingleLayerNetwok
    ...
    def predict(self, X):
        ...
        Y = np.random.random(size=(X.shape[0], 1))
